...
export default function ProfileTweet({urlBannere, urlProfil, userName, userEmail, userDescription, userCountry, userJoinTwitter}) {
        ...
        <div className="max-w-screen-md w-full">
           ...
           <div>
                <div className="w-full h-64">
                    <Image imgUrl={urlBannere} className="w-full h-full object-cover" />
                </div>
                <div className="flex justify-between items-start px-4" >
                    <div className="relative bottom-16 ">
                        <div className="profil-img-Hover">
                            <UserProfile size={150} urlProfil={urlProfil}  />
                        </div>
                    </div>
                ...
                <div className="-translate-y-8">
                    <div>
                        <h4 className="text-xl font-bold tracking-wider">{userName}</h4>
                        <div className="text-gray-400">{userEmail}</div>
                    </div>
                    <div className="mt-4">{userDescription}</div>
...
function UserProfile({size, urlProfil}) {
