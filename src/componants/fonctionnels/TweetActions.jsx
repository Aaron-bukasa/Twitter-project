...
export default function TweetActions({like, repost, comment}) {
    ...
    return (
        <div style={style}>
            <div className="flex items-center gap-x-1 tweet-action a1" >
                <svg className="p-2 rounded-full" width="40" height="40" viewBox="0 0 24 24" fill="#D9D9D9" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex items-center gap-x-1 tweet-action a2">
                <svg className="p-2 rounded-full" width="40" height="40" viewBox="0 0 24 24" fill="#D9D9D9" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex items-center gap-x-1 tweet-action a3" onClick = {handleLike}>
                <svg height="22" width="22" fill={isActive ? '#D21E1E' : '#ffffff'}  version="1.1" xmlns="http://www.w3.org/2000/svg" 
                        viewBox="0 0 511.999 511.999" xmlSpace="preserve">
                    <path fill={isActive ? '#f91880' : 'transparent'} d="M404.121,52.066c-15.078-4.814-29.245-7.037-42.436-7.037c-41.763,0-73.826,22.246-94.686,54.895
                ...
                <span className={isActive ? 'text-[#f91880]' : undefined}>{likes}</span>
            </div>
            <div className="flex items-center gap-x-1 tweet-action a4">
                <svg className="p-2 rounded-full" width="40" height="40" viewBox="0 0 24 24" fill="#D9D9D9" xmlns="http://www.w3.org/2000/svg">
