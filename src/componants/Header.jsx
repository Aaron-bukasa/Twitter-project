...
export default function Header({title}) {
    return (
        <div className="sticky top-0 py-2 bg-black border-b-2 border-solid border-gray-800 py-4 bg-[#000000d6] header">
            ...
            <div className="font-medium flex justify-between items-center px-16 py-1 sm:hidden">
                <Side link='tranding' txt="My tranding" />
                <Side link='follow' txt="Follow" />
            </div>
        </div>
    )
}